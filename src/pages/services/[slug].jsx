...
export default function ServiceDetail({ service }) {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="pt-32 md:pt-40 pb-16 md:pb-20 bg-[#111111] text-[#F3F3EF]">
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            <div className="lg:col-span-2">
              <FadeIn delay={100}>
                <p className="text-[#D6FF00] bg-black inline-block px-2 py-1 font-mono text-xs font-bold">
                  {service.number}
                </p>
              </FadeIn>
            </div>
            <div className="lg:col-span-10">
              <FadeIn delay={200}>
                ...
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-black uppercase tracking-tighter text-[#D6FF00] mb-6">
                  {service.headline}
                </h2>
                ...
                <div className="flex flex-wrap gap-2 md:gap-3 mt-6">
                  {service.tags.map((tag, i) => (
                    <span
                      key={i}
                      className="bg-white/10 px-3 py-1 font-mono text-[10px] md:text-xs uppercase"
                    >
                      {tag}
                    </span>
                  ))}
      ...
      <section className="bg-[#F3F3EF] text-[#111111] py-16 md:py-24">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20">
            ...
            <div>
              <FadeIn>
                <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tighter mb-8">
                  What We Deliver
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {service.benefits.map((benefit, i) => (
                    <FadeIn key={i} delay={200 + i * 50}>
                      <div className="border border-black/10 p-4 hover:bg-black hover:text-[#F3F3EF] transition-colors duration-300">
      ...
      {/* Process Timeline */}
      <section className="bg-[#111111] text-[#F3F3EF] py-16 md:py-24">
        <div className="container">
          <FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {service.process.map((phase, i) => (
              <FadeIn key={i} delay={i * 100}>
                <div className="border border-white/10 p-6 hover:border-[#D6FF00]/30 transition-colors">
                  <p className="text-[#D6FF00] font-mono text-xs uppercase mb-2">
                    {phase.duration}
                  </p>
                  <h4 className="text-lg md:text-xl font-black uppercase tracking-tighter mb-4">
                    {phase.phase}
                  </h4>
      ...
      <section className="bg-[#F3F3EF] text-[#111111] py-16 md:py-24">
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 mb-12">
                ...
                <div className="border border-black/10 p-6 md:p-8">
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      ...
                      <h4 className="text-2xl md:text-3xl font-black uppercase tracking-tighter mb-2">
            ...
            <div>
              <FadeIn delay={200}>
                <div className="bg-black text-[#F3F3EF] p-6 md:p-8 h-full">
                  <p className="font-mono text-xs uppercase text-[#D6FF00] mb-6">
                    Key Results
                  </p>
                  <div className="space-y-6">
                    {service.caseStudy.results.map((result, i) => (
                      <div key={i}>
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tighter text-[#D6FF00]">
                          {result.metric}
                        </p>
          ...
          <FadeIn delay={300}>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="border border-black/10 p-4 text-center hover:bg-black hover:text-[#F3F3EF] transition-colors">
              ...
              <div className="border border-black/10 p-4 text-center hover:bg-black hover:text-[#F3F3EF] transition-colors">
                <p className="text-2xl font-black mb-1">&lt;100ms</p>
                <p className="font-mono text-xs uppercase opacity-60">Response</p>
              </div>
              <div className="border border-black/10 p-4 text-center hover:bg-black hover:text-[#F3F3EF] transition-colors">
                <p className="text-2xl font-black mb-1">ISO</p>
