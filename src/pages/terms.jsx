...
const sections = [
  {
    ...
    body: [
      "By accessing the Ergofect website, submitting a form, booking an audit, reviewing a proposal, or engaging our services, you agree to these Terms of Service.",
      "If you are using Ergofect on behalf of a company or organization, you confirm that you have authority to accept these Terms on that entity's behalf.",
    ],
  },
  {
    id: "services",
    ...
    body: [
      "Ergofect provides AI automation strategy, workflow audits, solution design, development, integration, deployment, and optimization services.",
  ...
  },
  {
    ...
    body: [
      ...
      "You must ensure that any data, credentials, materials, or third-party systems shared with Ergofect may lawfully be used for the project.",
  ...
  },
  {
    ...
    body: [
      ...
      "Ergofect may pause work, access, support, or delivery if invoices remain unpaid after the agreed payment period.",
    ],
  },
  {
    id: "ip",
    ...
    body: [
      ...
      "Ergofect may reuse general knowledge, non-confidential methods, reusable components, automation patterns, and technical expertise developed during service delivery.",
    ],
  },
  {
    id: "data",
    ...
    body: [
      "You may provide business data, system access, documents, credentials, API keys, or workflow information so Ergofect can perform the services.",
      "Ergofect uses reasonable administrative, technical, and organizational safeguards to protect client materials, but no internet-connected service can be guaranteed completely secure.",
  ...
  },
  {
    ...
    body: [
      ...
      "Ergofect is not responsible for downtime, pricing changes, data loss, feature changes, or service limitations caused by third-party platforms.",
    ],
  },
  {
    id: "warranties",
    ...
    body: [
      "Ergofect will provide services in a professional and commercially reasonable manner.",
  ...
  },
  {
    ...
    body: [
      "To the maximum extent permitted by law, Ergofect is not liable for indirect, incidental, special, consequential, punitive, or lost-profit damages.",
      "Ergofect's total liability for claims related to the services is limited to the amount paid by you for the specific services giving rise to the claim during the three months before the claim.",
    ],
  },
  {
    id: "termination",
...
export default function TermsPage() {
  return (
    <>
      <Head>
        <title>Terms of Service - Ergofect.</title>
        <meta
          name="description"
          content="Ergofect Terms of Service for AI automation audits, consulting, implementation, and managed optimization services."
        />
      </Head>
        ...
        <div className="container">
          <FadeIn>
            ...
            <p className="text-sm md:text-lg opacity-70 leading-relaxed max-w-2xl">
              These terms explain how Ergofect works with clients, handles project scope,
