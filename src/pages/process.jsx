...
export default function Process() {
  return (
    <>
      <Head>
        <title>Our Process - KAIRO® | How We Automate</title>
        <meta
          name="description"
          content="Learn how KAIRO deploys AI automations in just 6 weeks — from process audit to live deployment with zero downtime."
        />
