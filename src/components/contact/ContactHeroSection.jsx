...
export default function ContactHeroSection() {
  return (
    <section className="pt-32 pb-16 md:pt-40 md:pb-20 min-h-[50vh] md:min-h-[60vh] flex flex-col justify-center bg-ink text-bone">
          ...
          <div>
            <FadeIn delay={100}>
              <h1 className="text-5xl md:text-[8vw] lg:text-[5.5vw] leading-[0.9] font-semibold tracking-[-0.04em]">
                ...
                <span className="text-cobalt-light">Together</span>.
              </h1>
            </FadeIn>
          </div>
