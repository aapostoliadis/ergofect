          ...
          <div>
            <FadeIn delay={100}>
              <h1 className="text-5xl md:text-[8vw] lg:text-[5.5vw] leading-[0.9] font-semibold tracking-[-0.04em]">
                Real Results From{" "}
                <span className="text-cobalt-light">Real</span> Companies.
              </h1>
            </FadeIn>
          </div>
          <div className="flex flex-col justify-end">
            ...
            <FadeIn delay={300}>
              <div className="grid grid-cols-3 gap-6 border-t border-bone/20 pt-6">
                <div>
                  <p className="text-3xl md:text-4xl font-semibold">12</p>
                ...
                <div>
                  <p className="text-3xl md:text-4xl font-semibold">$8.2M</p>
                  <p className="font-mono text-[10px] md:text-xs uppercase opacity-50 mt-1">
                    Saved for Clients
                  </p>
                </div>
