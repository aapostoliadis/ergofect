    ...
    <section className="bg-bone py-20 md:py-32 border-b border-ink/10">
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          <FadeIn delay={100}>
            <div className="relative min-h-[300px] md:min-h-[500px] border border-ink/10 overflow-hidden group">
              ...
              <div className="w-48 h-48 md:w-64 md:h-64 bg-cobalt-light rounded-full blur-[80px] md:blur-[100px] opacity-15 absolute top-0 -right-10"></div>
          ...
          <div className="flex flex-col justify-between">
            <div>
              <FadeIn delay={200}>
                <h2 className="text-3xl md:text-5xl font-semibold tracking-[-0.04em] leading-none mb-6">
                  Cut Support Costs By{" "}
                  <span className="text-cobalt-light bg-ink px-2 inline-block">62%</span>{" "}
                  And Sped Up Response{" "}
                  <span className="text-cobalt-light bg-ink px-2 inline-block">3X</span>.
                </h2>
              </FadeIn>
              <FadeIn delay={300}>
            ...
            <div>
              <FadeIn delay={400}>
                <div className="grid grid-cols-3 gap-6 border-t border-ink/20 pt-6 mb-8">
                  <div>
                    <p className="text-3xl md:text-4xl font-semibold">87%</p>
                    <p className="font-mono text-[10px] md:text-xs uppercase opacity-50 mt-1">
                      Time Saved
                    </p>
                  </div>
                  <div>
                    <p className="text-3xl md:text-4xl font-semibold">3X</p>
                    <p className="font-mono text-[10px] md:text-xs uppercase opacity-50 mt-1">
                      Resolution Speed
                    </p>
                  </div>
                  <div>
                    <p className="text-3xl md:text-4xl font-semibold">62%</p>
                    <p className="font-mono text-[10px] md:text-xs uppercase opacity-50 mt-1">
                      Cost Reduction
                    </p>
                  </div>
