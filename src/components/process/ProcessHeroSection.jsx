          ...
          <div>
            <FadeIn delay={100}>
              <h1 className="text-5xl md:text-[8vw] lg:text-[5.5vw] leading-[0.9] font-black uppercase tracking-tighter">
                From First Call To{" "}
                <span className="text-[#D6FF00]">Live</span> In 6 Weeks.
              </h1>
            </FadeIn>
          </div>
          <div className="flex flex-col justify-end">
            <FadeIn delay={200}>
              <p className="text-lg md:text-xl font-medium max-w-lg mb-8">
                We don&apos;t believe in 6-month rollouts. Our battle-tested
                framework gets you from zero to fully automated in weeks — with
                zero downtime and full team buy-in.
              </p>
            </FadeIn>
            <FadeIn delay={300}>
              <div className="grid grid-cols-3 gap-6 border-t border-white/20 pt-6">
                ...
                <div>
                  <p className="text-3xl md:text-4xl font-black">4</p>
                  <p className="font-mono text-[10px] md:text-xs uppercase opacity-50 mt-1">
                    Clear Phases
                  </p>
                </div>
