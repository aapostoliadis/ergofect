    ...
    <section className="bg-[#111111] text-[#F3F3EF] py-20 md:py-32 border-t border-white/10">
      <div className="container">
        <FadeIn>
          ...
          <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-6 max-w-4xl">
            We Plug Into Your{" "}
            <span className="text-[#D6FF00]">Existing</span> Stack.
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
          {toolGroups.map((group, i) => (
            <FadeIn key={i} delay={i * 80} className="border border-white/10 p-4 md:p-6">
              <p className="font-mono text-[10px] md:text-xs uppercase text-[#D6FF00] mb-4 font-bold">
                {group.label}
              </p>
